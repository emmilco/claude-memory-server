...
@pytest.mark.asyncio
async def test_list_all_memories(server):
...
@pytest.mark.asyncio
async def test_filter_by_category(server):
    """Test filtering memories by category."""
    result = await server.list_memories(category="preference", limit=100)
...
@pytest.mark.asyncio
async def test_sort_by_importance_desc(server):
...
@pytest.mark.asyncio
async def test_sort_by_importance_asc(server):
...
@pytest.mark.asyncio
async def test_pagination_first_page(server):
    """Test pagination - first page."""
    result = await server.list_memories(limit=2, offset=0)
...
@pytest.mark.asyncio
async def test_pagination_second_page(server):
    """Test pagination - second page."""
    result = await server.list_memories(limit=2, offset=2)
...
@pytest.mark.asyncio
async def test_combined_filters(server):
...
@pytest.mark.asyncio
async def test_empty_results(server):
...
@pytest.mark.asyncio
async def test_memory_content_in_response(server):
    """Test that memory details are included in response."""
    result = await server.list_memories(limit=1)
...
@pytest.mark.asyncio
async def test_date_filtering(server):
