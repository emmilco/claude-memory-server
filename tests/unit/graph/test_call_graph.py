...
class TestCallGraphSearch:
    ...
    def test_find_callers_direct_only(self):
        ...
        graph.add_function(
            FunctionNode("helper", "helper", "/helper.py", "python", 1, 5)
        )
...
class TestCallChains:
    ...
    def test_find_call_chain_single_path(self):
        ...
        graph.add_call(
            CallSite("process", "/process.py", 1, "validate", "/validate.py")
        )
...
class TestImplementations:
    ...
    def test_get_implementations_multiple(self):
        ...
        impl1 = InterfaceImplementation(
            "Storage", "RedisStorage", "/redis.py", "python", ["get", "set"]
        )
        impl2 = InterfaceImplementation(
            "Storage", "MemoryStorage", "/memory.py", "python", ["get", "set"]
        )
...
class TestStatistics:
    ...
    def test_get_statistics(self):
        ...
        graph.add_implementation(
            InterfaceImplementation("I", "Impl", "/impl.py", "python", [])
        )
